...
const TopAppBarShortPage = () => {
  return (
      <TopAppBarShort />
  );
};

class TopAppBarShort extends Component {
  constructor(props) {
    super(props);
    this.topAppBar = null
  ...
  render() {
    return (
        <div style={{height: '500px'}}>
          <header className='mdc-top-app-bar mdc-top-app-bar--short' ref={this.initTopAppBar}>
...
export default TopAppBarShortPage;