...
const TopAppBarFixedPage = () => {
  return (
      <TopAppBarFixed />
  );
};

class TopAppBarFixed extends Component {
  constructor(props) {
    super(props);
    this.topAppBar = null
  ...
  render() {
    return (
        <div style={{height: '500px'}}>
          <header className='mdc-top-app-bar mdc-top-app-bar--fixed' ref={this.initTopAppBar}>
...
export default TopAppBarFixedPage;