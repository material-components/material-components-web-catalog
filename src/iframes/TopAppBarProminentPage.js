...
const TopAppBarProminentPage = () => {
  return (
      <TopAppBarProminent />
  );
};

class TopAppBarProminent extends Component {
  constructor(props) {
    super(props);
    this.topAppBar = null
  ...
  render() {
    return (
        <div style={{height: '500px'}}>
          <header className='mdc-top-app-bar mdc-top-app-bar--prominent' ref={this.initTopAppBar}>
...
export default TopAppBarProminentPage;